...
3) [Bu Videoyu](https://www.youtube.com/watch?v=--1-cfnicJ8) izleyin ve ikinci derecede denklemin nasıl Google Sheet ile çizileceğini öğrenin. Bu videoda bir karenin kenar uzunluğu ile alanın değişme grafiği çizilmiştir. Yani bu video için denkleminiz *y = x^2* şeklinde değişmiş. Yani *a=1, b=0,c=0* dır. Videodaki [grafik](https://docs.google.com/spreadsheets/d/19ifc52ua9o2nFTx7wph5lI2m_ZIhkYl2KJo4AZgFUfE/edit#gid=0)
...
Yukarıdaki örneği kullanarak **kendi ölçümlerinizle** bir tablo oluşturun (Aşağıda yeni bir tablo oluşturun ve yukarıdaki tabloya 3-4 tane kendi ölçümünü ekleyiniz.) Kullandığınız Google Sheet için [link](https://docs.google.com/spreadsheets/d/1nbIL4y1cgpPZaoYOPm0hIsfhr5opMdn8orE2H0dWwnI/edit#gid=0) (Google Sheet herkese açık erişimli olsun.) 
...
a) Denkleminizi **buraya yazınız**: **x = -1.22*t^2 + 1.81*t + 3.42E-0.3 (x= konum, t= zaman)**. Sizce a, b, ve c'nin fiziksel anlamları ne olabilir? (Yardım: bir tanesi ivme ile ilgili, bir tanesi ilk hız ile, diğeri konum ile ilgili).  Sizce niçin a'nın değeri negatif? *a'nın değeri negatiftir çünkü cisim ivmeli (yavaşlayan) hareket göstermektedir. a= ivme, b= ilk hız, c= konum* 

b) Hava sürtünmesini ihmal edersek, bu harakette ivme sabit midir? *Hayır. Çünkü cisme etki eden 2 tane sürtünme kuvveti vardır. Hava sürtünmesini ihmal etsek bile cismin yüzey ile temasından meydana gelen sürtünme kuvveti devam edecektir. Bu yüzden de ivme sabit olamaz.*

c) Video'daki cismin atılış hızı farklı olsaydı (diğer her şey aynı, kütle, yüzey, vb. Hava sürtünmesini ihmal edin), sizce formülde hangi terimler değişecekti? (a, b veya c) *b ve a terimleri değişecektir.*
...
1) Kendi aldığınız verileri kullanarak **ortalama hız-zaman** grafiğini Google çiziniz. [Ortalama hız ve ivme grafiği linki](https://docs.google.com/spreadsheets/d/1YX_CoU7NOu_aY8k9Myv829SLR8rAhiyJJnldcE8GcFs/edit#gid=0).
...
1) Bu deneyde ölçüm hatalarım var. Zamandaki ölçüm hatam sizce kaç ms (mili saniye) nedir? Konumdaki ölçüm hatam sizce kaç cm'dir? *Konumdaki ölçüm hatası 1cm oynayabilir. Zamandaki ölçüm hatası ise 300ms değil 16ms'dir.*
